...
import { getMyProfile, register } from '../../redux/action/user'
...
const Otp = () => {
  ...
  const submitHandler=(e)=>{
    ...
    if(otp.length<6){
      ...
      if(stat.refer_number==undefined){
        console.log(stat.username,stat.phone_number,stat.refer_number,otp)
        dispatch(register(stat.username,stat.phone_number,'',otp))
      }else{
        console.log(stat.username,stat.phone_number,stat.refer_number,otp)
        dispatch(register(stat.username,stat.phone_number,stat.referal_from,otp))
      }
    }
