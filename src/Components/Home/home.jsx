    ...
    <section className='home'>
      <div className='container'>
        ...
        >
          {isLargerThan800 ? (
          <Box>
              <VStack border='2px'  borderRadius='lg' borderColor='#D2D2D2' color='black' width={'50%'}  mt='1rem' mx='25%'>
          <Image p='1' boxSize={'md'} border={4} borderColor='black'  src={img} borderRadius={4} alt="logo" />
          <Text color={'black'} pt='12'px='3' fontFamily={['Poppins,sans-serif']} fontSize={['small','medium']} fontWeight='light' children={"This Game involves an element of financial risk and may be addictive. Please Play responsibly and at your own risk."}/>
              ...
              <HStack  bottom={'20%'} spacing={"5"} flex={1} pr='2' pt='2'   justifyContent={"center"}>
            <Button w={'40%'}  bg='black' color={'white'}  variant='solid'>
              Play Now
            </Button>
